...
numbers.shift();
numbers.pop();
console.log('Array setelah penghapusan:', numbers);
...
colors.push('Ungu');
console.log('Array setelah penambahan:', colors);
...
const correctNumber = Math.floor(Math.random()*10 + 1); 
    ...
    function checkGuess() { 
        ...
        if (isNaN(userGuess) || userGuess < 1 || userGuess > 10) { 
            ...
            resultDiv.textContent = "Selamat anda menabak angka yang benar" + correctNumber; 
        } else { 
